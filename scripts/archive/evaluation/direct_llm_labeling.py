...
TEST_FILES = {
    "abt-buy":        ROOT / "benchmarks/abt-buy/abt-buy-gs.json.gz",
    "walmart-amazon": ROOT / "benchmarks/walmart-amazon/walmart-amazon-gs.json.gz",
    "dblp-acm":       ROOT / "benchmarks/dblp-acm/dblp-acm-gs.json.gz",
    "dblp-scholar":   ROOT / "benchmarks/dblp-scholar/dblp-scholar-gs.json.gz",
    "wdc":            ROOT / "benchmarks/wdc/wdcproducts80cc20rnd100un_gs.json.gz",
}
