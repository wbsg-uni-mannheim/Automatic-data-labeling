...
def _build_method_guide_rows(methods_in_overview: List[str]) -> pd.DataFrame:
    method_rows = {
        ...
        "Seed Round Only": {
            ...
            "prompt_source": (
                "scripts/labeling/similarity_search.py, reusing seed functions from "
                "scripts/labeling/active_learning_ml.py"
            ),
        ...
        "Simple Active Learning": {
            ...
            "prompt_source": "scripts/labeling/active_learning_ml.py (_label_pair)",
        ...
        "Three-Phase Active Learning v2": {
            ...
            "prompt_source": (
                "scripts/labeling/active_learning_ml.py (_label_pair), reused by "
                "scripts/labeling/active_learning_ditto.py"
            ),
        ...
        "Three-Phase v2 + Batch Relabel": {
            ...
            "prompt_source": (
                "Initial prompt: scripts/labeling/active_learning_ml.py (_label_pair). "
                "Relabel prompt: scripts/archive/review_workflows/experiments/evidence_first_abstain/prompts/"
        ...
        "Three-Phase v2 + Drop Changed": {
            ...
            "prompt_source": (
                "Initial prompt: scripts/labeling/active_learning_ml.py (_label_pair). "
                "Disagreement signal: scripts/archive/review_workflows/experiments/evidence_first_abstain/prompts/"
                "agent_precision_system_prompt.txt via "
        ...
        "Three-Phase v2 + Closure Bridge + Relabel-Changed Drop": {
            ...
            "prompt_source": (
                ...
                "--require-relabel-changed. Relabel signal: scripts/archive/review_workflows/experiments/"
        ...
        "Three-Phase v2 + Closure Bridge OR Relabel-Changed Drop": {
            ...
            "prompt_source": (
                ...
                "--include-relabel-changed. Relabel signal: scripts/archive/review_workflows/experiments/"
                "evidence_first_abstain/prompts/agent_precision_system_prompt.txt"
            ),
