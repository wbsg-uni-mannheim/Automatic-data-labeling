...
sys.path.insert(0, str(ROOT / "scripts" / "archive" / "evaluation"))
...
def _materialize_dataset(dataset_dir: Path) -> Dict[str, Any]:
    ...
    updated_manifest["runner_script"] = "scripts/post_processing/relabel_three_phase_generated_labels_batch.py"
