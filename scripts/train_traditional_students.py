...
scripts/labeling/run_simple_labeling.py:_build_feature_matrix).
...
SOURCES[("abt-buy",        "benchmark")] = ROOT / "data/abt-buy/abt-buy-train.json"
SOURCES[("walmart-amazon", "benchmark")] = ROOT / "data/walmart-amazon/walmart-amazon-train.json.gz"
SOURCES[("dblp-acm",       "benchmark")] = ROOT / "data/dblp-acm/dblp-acm-train.json.gz"
SOURCES[("dblp-scholar",   "benchmark")] = ROOT / "data/dblp-scholar/dblp-scholar-train.json.gz"
SOURCES[("wdc",            "benchmark")] = ROOT / "data/wdc/wdcproducts80cc20rnd000un_train_large.json.gz"
...
BENCHMARK_CONFIGS = {
    "abt-buy": {
        "test":          ROOT / "data/abt-buy/abt-buy-gs.json.gz",
        "left_csv":      ROOT / "data/abt-buy/abt-buy-train-left.csv",
        "right_csv":     ROOT / "data/abt-buy/abt-buy-train-right.csv",
        "left_emb":      ROOT / "data/abt-buy/embeddings/abt-buy_left_embeddings.npy",
        "right_emb":     ROOT / "data/abt-buy/embeddings/abt-buy_right_embeddings.npy",
        "fields":        ["title", "description", "price"],
        "field_aliases": {"title": ["name"]},  # test uses 'name' instead of 'title'
    },
    "walmart-amazon": {
        "test":      ROOT / "data/walmart-amazon/walmart-amazon-gs.json.gz",
        "left_csv":  ROOT / "data/walmart-amazon/walmart-amazon-train-left.csv",
        "right_csv": ROOT / "data/walmart-amazon/walmart-amazon-train-right.csv",
        "left_emb":  ROOT / "data/walmart-amazon/embeddings/walmart-amazon_left_embeddings.npy",
        "right_emb": ROOT / "data/walmart-amazon/embeddings/walmart-amazon_right_embeddings.npy",
        "fields":    ["title", "category", "brand", "modelno", "price"],
    },
    "dblp-acm": {
        "test":      ROOT / "data/dblp-acm/dblp-acm-gs.json.gz",
        "left_csv":  ROOT / "data/dblp-acm/dblp-acm-train-left.csv",
        "right_csv": ROOT / "data/dblp-acm/dblp-acm-train-right.csv",
        "left_emb":  ROOT / "data/dblp-acm/embeddings/dblp-acm_left_embeddings.npy",
        "right_emb": ROOT / "data/dblp-acm/embeddings/dblp-acm_right_embeddings.npy",
        "fields":    ["title", "authors", "venue", "year"],
    },
    "dblp-scholar": {
        "test":      ROOT / "data/dblp-scholar/dblp-scholar-gs.json.gz",
        "left_csv":  ROOT / "data/dblp-scholar/dblp-scholar-train-left.csv",
        "right_csv": ROOT / "data/dblp-scholar/dblp-scholar-train-right.csv",
        "left_emb":  ROOT / "data/dblp-scholar/embeddings/dblp-scholar_left_embeddings.npy",
        "right_emb": ROOT / "data/dblp-scholar/embeddings/dblp-scholar_right_embeddings.npy",
        "fields":    ["title", "authors", "venue", "year"],
    },
    "wdc": {
        "test":      ROOT / "data/wdc/wdcproducts80cc20rnd100un_gs.json.gz",
        "left_csv":  ROOT / "data/wdc/wdc_train_large_left.csv",
        "right_csv": ROOT / "data/wdc/wdc_train_large_right.csv",
        "left_emb":  ROOT / "data/wdc/embeddings/wdc_left_embeddings.npy",
        "right_emb": ROOT / "data/wdc/embeddings/wdc_right_embeddings.npy",
        "fields":    ["title", "brand", "description", "price", "priceCurrency"],
    },
}


# ─── Feature helpers (copied from run_simple_labeling.py for consistency) ──
def _norm_text(v):
